...
> TFOutputResponseDTO create_or_update_output(body)
...
body = swagger_client.TFOutputRequestDTO() # TFOutputRequestDTO | 
...
------------- | ------------- | ------------- | -------------
 **body** | [**TFOutputRequestDTO**](TFOutputRequestDTO.md)|  | 
...
# **get_all_outputs**
> list[TFOutputResponseDTO] get_all_outputs()
...
# **get_output_by_name**
> TFOutputResponseDTO get_output_by_name(name, namespace)
...
> list[TFOutputResponseDTO] get_outputs_by_provider_source(source)
