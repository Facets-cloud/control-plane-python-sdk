...
> ComCapillaryOpsCpBoCostDtoDailyCloudCostDTO get_daily_cloud_cost(stack_name, start, end, cluster_ids=cluster_ids)
...
[**ComCapillaryOpsCpBoCostDtoDailyCloudCostDTO**](ComCapillaryOpsCpBoCostDtoDailyCloudCostDTO.md)
...
> list[ComCapillaryOpsCpBoCostDailyCost] get_service_wise_cost(cluster_id, start, end)
...
[**list[ComCapillaryOpsCpBoCostDailyCost]**](ComCapillaryOpsCpBoCostDailyCost.md)
