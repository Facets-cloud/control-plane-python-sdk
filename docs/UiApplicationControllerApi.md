...
# **get_events**
> list[IoFabric8KubernetesApiModelEvent] get_events(cluster_id, pod_name)
...
[**list[IoFabric8KubernetesApiModelEvent]**](IoFabric8KubernetesApiModelEvent.md)
...
# **get_hpa**
> IoFabric8KubernetesApiModelAutoscalingV2HorizontalPodAutoscaler get_hpa(cluster_id, application_name)
...
[**IoFabric8KubernetesApiModelAutoscalingV2HorizontalPodAutoscaler**](IoFabric8KubernetesApiModelAutoscalingV2HorizontalPodAutoscaler.md)
...
# **get_ingresses**
> list[IoFabric8KubernetesApiModelNetworkingV1Ingress] get_ingresses(cluster_id, application_name)
...
[**list[IoFabric8KubernetesApiModelNetworkingV1Ingress]**](IoFabric8KubernetesApiModelNetworkingV1Ingress.md)
...
> ComCapillaryOpsCpBoHistoryResourceHistory get_resource_history(cluster_id, resource_type, resource_name)
...
[**ComCapillaryOpsCpBoHistoryResourceHistory**](ComCapillaryOpsCpBoHistoryResourceHistory.md)
...
> ComCapillaryOpsCpBoReleaseResourceOutProperties get_resource_out_properties(cluster_id, resource_type, resource_name)
...
[**ComCapillaryOpsCpBoReleaseResourceOutProperties**](ComCapillaryOpsCpBoReleaseResourceOutProperties.md)
...
> ComCapillaryOpsCpBoOverrideObject get_resource_override_object(cluster_id, resource_name, resource_type)
...
[**ComCapillaryOpsCpBoOverrideObject**](ComCapillaryOpsCpBoOverrideObject.md)
...
# **get_validations**
> list[ComCapillaryOpsCpBoResoucesValidationResponse] get_validations(cluster_id)
...
[**list[ComCapillaryOpsCpBoResoucesValidationResponse]**](ComCapillaryOpsCpBoResoucesValidationResponse.md)
...
# **list_pods**
> list[IoFabric8KubernetesApiModelPod] list_pods(cluster_id, application_name)
...
[**list[IoFabric8KubernetesApiModelPod]**](IoFabric8KubernetesApiModelPod.md)
...
# **logs**
> OrgSpringframeworkWebServletMvcMethodAnnotationStreamingResponseBody logs(cluster_id, pod_name, labels)
...
> ComCapillaryOpsCpBoOverrideObject post_resource_override_object(body, cluster_id, resource_name, resource_type, do_sync=do_sync)
...
# create an instance of the API class
api_instance = swagger_client.UiApplicationControllerApi(swagger_client.ApiClient(configuration))
body = swagger_client.ComCapillaryOpsCpBoRequestsOverrideRequest() # ComCapillaryOpsCpBoRequestsOverrideRequest | 
cluster_id = 'cluster_id_example' # str | 
resource_name = 'resource_name_example' # str | 
resource_type = 'resource_type_example' # str | 
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**ComCapillaryOpsCpBoRequestsOverrideRequest**](ComCapillaryOpsCpBoRequestsOverrideRequest.md)|  | 
 **cluster_id** | **str**|  | 
 **resource_name** | **str**|  | 
 **resource_type** | **str**|  | 
