...
> CoderWorkspaceResponse create_workspace_with_existing_branch(body, stack_name, resource_type, resource_name)
...
body = swagger_client.CreateWorkspaceExistingBranchRequest() # CreateWorkspaceExistingBranchRequest | 
...
------------- | ------------- | ------------- | -------------
 **body** | [**CreateWorkspaceExistingBranchRequest**](CreateWorkspaceExistingBranchRequest.md)|  | 
 **stack_name** | **str**|  | 
 **resource_type** | **str**|  | 
 **resource_name** | **str**|  | 
...
> CoderWorkspaceResponse create_workspace_with_existing_branch1(body, stack_name)
...
> CoderWorkspaceResponse create_workspace_with_new_branch(body, stack_name, resource_type, resource_name)
...
# create an instance of the API class
api_instance = swagger_client.UiCoderControllerApi(swagger_client.ApiClient(configuration))
body = swagger_client.CreateWorkspaceNewBranchRequest() # CreateWorkspaceNewBranchRequest | 
stack_name = 'stack_name_example' # str | 
resource_type = 'resource_type_example' # str | 
resource_name = 'resource_name_example' # str | 
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**CreateWorkspaceNewBranchRequest**](CreateWorkspaceNewBranchRequest.md)|  | 
 **stack_name** | **str**|  | 
 **resource_type** | **str**|  | 
 **resource_name** | **str**|  | 
...
> CoderWorkspaceResponse create_workspace_with_new_branch1(body, stack_name)
...
# **get_all3**
> list[CoderWorkspaceResponse] get_all3(stack_name)
...
# **get_all4**
> list[CoderWorkspaceResponse] get_all4(stack_name, resource_type, resource_name)
...
> CoderLaunchEligibilityResponse identify_coder_launch_eligible(stack_name)
