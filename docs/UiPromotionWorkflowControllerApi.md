...
# **create_workflow**
> PromotionWorkflow create_workflow(body)
...
body = swagger_client.PromotionWorkflow() # PromotionWorkflow | 
...
------------- | ------------- | ------------- | -------------
 **body** | [**PromotionWorkflow**](PromotionWorkflow.md)|  | 
...
# **delete_workflow**
> PromotionWorkflow delete_workflow(workflow_id)
...
# **get_all_workflows**
> list[PromotionWorkflow] get_all_workflows()
...
> PromotionWorkflow get_default_workflow(registration_type, stack_name=stack_name)
...
> list[PromotionWorkflow] get_registration_specific_workflows(registration_type, stack_name=stack_name)
...
# **get_workflow**
> PromotionWorkflow get_workflow(workflow_id)
...
> list[PromotionWorkflow] get_workflows_by_stack(stack_name)
...
# **update_workflow**
> PromotionWorkflow update_workflow(body, workflow_id)
