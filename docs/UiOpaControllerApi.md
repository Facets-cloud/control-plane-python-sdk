...
body = [swagger_client.ComCapillaryOpsCpBoOpaEnableDisableOPAPolicy()] # list[ComCapillaryOpsCpBoOpaEnableDisableOPAPolicy] | 
...
------------- | ------------- | ------------- | -------------
 **body** | [**list[ComCapillaryOpsCpBoOpaEnableDisableOPAPolicy]**](ComCapillaryOpsCpBoOpaEnableDisableOPAPolicy.md)|  | 
...
# **create_policy**
> ComCapillaryOpsCpBoOpaOpaPolicy create_policy(body, policy_name)
...
# create an instance of the API class
api_instance = swagger_client.UiOpaControllerApi(swagger_client.ApiClient(configuration))
body = swagger_client.ComCapillaryOpsCpBoOpaOpaPolicyRequest() # ComCapillaryOpsCpBoOpaOpaPolicyRequest | 
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**ComCapillaryOpsCpBoOpaOpaPolicyRequest**](ComCapillaryOpsCpBoOpaOpaPolicyRequest.md)|  | 
 **policy_name** | **str**|  | 

### Return type

[**ComCapillaryOpsCpBoOpaOpaPolicy**](ComCapillaryOpsCpBoOpaOpaPolicy.md)
...
# **edit_policy**
> ComCapillaryOpsCpBoOpaOpaPolicy edit_policy(body, policy_name)
...
# **execute_policy**
> ComCapillaryOpsCpBoOpaOpaPolicyExecutionResult execute_policy(body, policy_name)
...
[**ComCapillaryOpsCpBoOpaOpaPolicyExecutionResult**](ComCapillaryOpsCpBoOpaOpaPolicyExecutionResult.md)
...
# **get_all_policies**
> list[ComCapillaryOpsCpBoOpaOpaPolicy] get_all_policies()
...
[**list[ComCapillaryOpsCpBoOpaOpaPolicy]**](ComCapillaryOpsCpBoOpaOpaPolicy.md)
...
> list[ComCapillaryOpsCpBoOpaPolicyTemplateDTO] get_all_policy_templates()
...
[**list[ComCapillaryOpsCpBoOpaPolicyTemplateDTO]**](ComCapillaryOpsCpBoOpaPolicyTemplateDTO.md)
...
# **get_policy**
> ComCapillaryOpsCpBoOpaOpaPolicy get_policy(policy_name)
