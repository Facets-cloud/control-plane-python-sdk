...
# **analyze_access**
> list[AccessAnalyzerResponse] analyze_access(permissions)
...
# **create_token**
> list[UserAccessToken] create_token(token)
...
# create an instance of the API class
api_instance = swagger_client.UiUserControllerApi(swagger_client.ApiClient(configuration))
token = swagger_client.UserAccessToken() # UserAccessToken | 
...
# **delete_token**
> list[UserAccessToken] delete_token(token_id)
...
> list[ExpandedUser] get_all_users_expanded()
...
# **get_token**
> list[UserAccessToken] get_token()
...
# **get_user_expanded**
> ExpandedUser get_user_expanded(user_id)
...
# create an instance of the API class
api_instance = swagger_client.UiUserControllerApi(swagger_client.ApiClient(configuration))
body = swagger_client.InviteUserRequest() # InviteUserRequest | 
