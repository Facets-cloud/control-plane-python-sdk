...
# **create_component**
> WebComponentDTO create_component(body)
...
body = swagger_client.WebComponentDTO() # WebComponentDTO | 
...
------------- | ------------- | ------------- | -------------
 **body** | [**WebComponentDTO**](WebComponentDTO.md)|  | 
...
# **get_all_components**
> list[WebComponentDTO] get_all_components()
...
# **get_component**
> WebComponentDTO get_component(web_component_id)
...
# **update_component**
> WebComponentDTO update_component(body, web_component_id)
