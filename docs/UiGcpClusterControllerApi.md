...
> ComCapillaryOpsCpBoGCPCluster configure_draft_cluster(body, cluster_id)
...
# **create_gcp_cluster**
> ComCapillaryOpsCpBoGCPCluster create_gcp_cluster(body)
...
# **get_gcp_cluster**
> ComCapillaryOpsCpBoGCPCluster get_gcp_cluster(cluster_id)
...
# **update_gcp_cluster**
> ComCapillaryOpsCpBoGCPCluster update_gcp_cluster(body, cluster_id)
