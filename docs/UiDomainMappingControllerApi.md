...
body = swagger_client.ComCapillaryOpsCpBoDomainDomainDTO() # ComCapillaryOpsCpBoDomainDomainDTO | 
...
------------- | ------------- | ------------- | -------------
 **body** | [**ComCapillaryOpsCpBoDomainDomainDTO**](ComCapillaryOpsCpBoDomainDomainDTO.md)|  | 
 **cluster_id** | **str**|  | 
 **resource_type** | **str**|  | 
 **resource_name** | **str**|  | 
...
# **get_all_domains**
> list[ComCapillaryOpsCpBoDomainDomainDTO] get_all_domains(cluster_id, resource_type, resource_name)
...
[**list[ComCapillaryOpsCpBoDomainDomainDTO]**](ComCapillaryOpsCpBoDomainDomainDTO.md)
