...
class UiSettingsControllerApi(object):
    ...
    def add_setting_value_using_put(self, entity_id, entity_type, setting_value_request, **kwargs):  # noqa: E501
        """addSettingValue  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.add_setting_value_using_put(entity_id, entity_type, setting_value_request, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str entity_id: entityId (required)
        :param str entity_type: entityType (required)
        :param object setting_value_request: settingValueRequest (required)
        :return: object
        ...
        if kwargs.get('async_req'):
            return self.add_setting_value_using_put_with_http_info(entity_id, entity_type, setting_value_request, **kwargs)  # noqa: E501
        else:
            (data) = self.add_setting_value_using_put_with_http_info(entity_id, entity_type, setting_value_request, **kwargs)  # noqa: E501
            return data

    def add_setting_value_using_put_with_http_info(self, entity_id, entity_type, setting_value_request, **kwargs):  # noqa: E501
        """addSettingValue  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.add_setting_value_using_put_with_http_info(entity_id, entity_type, setting_value_request, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['entity_id', 'entity_type', 'setting_value_request']  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('setting_value_request' not in params or
                                                       params['setting_value_request'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `setting_value_request` when calling `add_setting_value_using_put`")  # noqa: E501
        ...
        body_params = None
        if 'setting_value_request' in params:
            body_params = params['setting_value_request']
        # HTTP header `Accept`
