...
class UiApplicationControllerApi(object):
    ...
    def post_resource_override_object_using_post(self, cluster_id, override_request, resource_name, resource_type, **kwargs):  # noqa: E501
        """postResourceOverrideObject  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.post_resource_override_object_using_post(cluster_id, override_request, resource_name, resource_type, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str cluster_id: clusterId (required)
        :param OverrideRequest override_request: overrideRequest (required)
        :param str resource_name: resourceName (required)
        :param str resource_type: resourceType (required)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.post_resource_override_object_using_post_with_http_info(cluster_id, override_request, resource_name, resource_type, **kwargs)  # noqa: E501
        else:
            (data) = self.post_resource_override_object_using_post_with_http_info(cluster_id, override_request, resource_name, resource_type, **kwargs)  # noqa: E501
            return data

    def post_resource_override_object_using_post_with_http_info(self, cluster_id, override_request, resource_name, resource_type, **kwargs):  # noqa: E501
        """postResourceOverrideObject  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.post_resource_override_object_using_post_with_http_info(cluster_id, override_request, resource_name, resource_type, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['cluster_id', 'override_request', 'resource_name', 'resource_type', 'do_sync']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        # verify the required parameter 'override_request' is set
        if self.api_client.client_side_validation and ('override_request' not in params or
                                                       params['override_request'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `override_request` when calling `post_resource_override_object_using_post`")  # noqa: E501
        # verify the required parameter 'resource_name' is set
        if self.api_client.client_side_validation and ('resource_name' not in params or
                                                       params['resource_name'] is None):  # noqa: E501
        ...
        body_params = None
        if 'override_request' in params:
            body_params = params['override_request']
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.select_header_accept(
            ['*/*'])  # noqa: E501
