...
class GcpClusterControllerApi(object):
    ...
    def update_cluster(self, body, cluster_id, **kwargs):  # noqa: E501
        """update_cluster  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_cluster(body, cluster_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.update_cluster_with_http_info(body, cluster_id, **kwargs)  # noqa: E501
        else:
            (data) = self.update_cluster_with_http_info(body, cluster_id, **kwargs)  # noqa: E501
            return data

    def update_cluster_with_http_info(self, body, cluster_id, **kwargs):  # noqa: E501
        """update_cluster  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_cluster_with_http_info(body, cluster_id, async_req=True)
        >>> result = thread.get()
