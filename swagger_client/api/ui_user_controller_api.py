...
class UiUserControllerApi(object):
    ...
    def invite_users_using_post(self, invite_user_request, **kwargs):  # noqa: E501
        """inviteUsers  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.invite_users_using_post(invite_user_request, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param InviteUserRequest invite_user_request: inviteUserRequest (required)
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.invite_users_using_post_with_http_info(invite_user_request, **kwargs)  # noqa: E501
        else:
            (data) = self.invite_users_using_post_with_http_info(invite_user_request, **kwargs)  # noqa: E501
            return data

    def invite_users_using_post_with_http_info(self, invite_user_request, **kwargs):  # noqa: E501
        """inviteUsers  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.invite_users_using_post_with_http_info(invite_user_request, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('invite_user_request' not in params or
                                                       params['invite_user_request'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `invite_user_request` when calling `invite_users_using_post`")  # noqa: E501
        ...
        body_params = None
        if 'invite_user_request' in params:
            body_params = params['invite_user_request']
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.select_header_accept(
            ['*/*'])  # noqa: E501
    ...
    def update_password_using_post(self, update_password_request, **kwargs):  # noqa: E501
        """updatePassword  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_password_using_post(update_password_request, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param PasswordChange update_password_request: updatePasswordRequest (required)
        :return: Response
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.update_password_using_post_with_http_info(update_password_request, **kwargs)  # noqa: E501
        else:
            (data) = self.update_password_using_post_with_http_info(update_password_request, **kwargs)  # noqa: E501
            return data

    def update_password_using_post_with_http_info(self, update_password_request, **kwargs):  # noqa: E501
        """updatePassword  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_password_using_post_with_http_info(update_password_request, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('update_password_request' not in params or
                                                       params['update_password_request'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `update_password_request` when calling `update_password_using_post`")  # noqa: E501
        ...
        body_params = None
        if 'update_password_request' in params:
            body_params = params['update_password_request']
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.select_header_accept(
            ['*/*'])  # noqa: E501
