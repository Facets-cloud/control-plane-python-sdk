...
class UiOneTimeWebhookControllerApi(object):
    ...
    def register_webhook_using_post(self, webhook, **kwargs):  # noqa: E501
        """registerWebhook  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.register_webhook_using_post(webhook, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param OneTimeWebhook webhook: webhook (required)
        :return: OneTimeWebhook
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.register_webhook_using_post_with_http_info(webhook, **kwargs)  # noqa: E501
        else:
            (data) = self.register_webhook_using_post_with_http_info(webhook, **kwargs)  # noqa: E501
            return data

    def register_webhook_using_post_with_http_info(self, webhook, **kwargs):  # noqa: E501
        """registerWebhook  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.register_webhook_using_post_with_http_info(webhook, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('webhook' not in params or
            ...
            raise ValueError("Missing the required parameter `webhook` when calling `register_webhook_using_post`")  # noqa: E501
