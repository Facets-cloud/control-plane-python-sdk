...
class UiTfModuleControllerApi(object):
    ...
    def get_facets_yaml_by_stack_using_get(self, flavor, intent, stack_name, version, **kwargs):  # noqa: E501
        """Get facets.yaml by Stack  # noqa: E501

        - **Description:** Retrieves facets.yaml by stack information. - **Audit Logging:** No specific audit logging at the moment.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_facets_yaml_by_stack_using_get(flavor, intent, stack_name, version, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_facets_yaml_by_stack_using_get_with_http_info(flavor, intent, stack_name, version, **kwargs)  # noqa: E501
        else:
            (data) = self.get_facets_yaml_by_stack_using_get_with_http_info(flavor, intent, stack_name, version, **kwargs)  # noqa: E501
            return data

    def get_facets_yaml_by_stack_using_get_with_http_info(self, flavor, intent, stack_name, version, **kwargs):  # noqa: E501
        """Get facets.yaml by Stack  # noqa: E501

        - **Description:** Retrieves facets.yaml by stack information. - **Audit Logging:** No specific audit logging at the moment.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_facets_yaml_by_stack_using_get_with_http_info(flavor, intent, stack_name, version, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_facets_yaml_by_stack_using_get" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if self.api_client.client_side_validation and ('flavor' not in params or
            ...
            raise ValueError("Missing the required parameter `flavor` when calling `get_facets_yaml_by_stack_using_get`")  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('intent' not in params or
            ...
            raise ValueError("Missing the required parameter `intent` when calling `get_facets_yaml_by_stack_using_get`")  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('stack_name' not in params or
            ...
            raise ValueError("Missing the required parameter `stack_name` when calling `get_facets_yaml_by_stack_using_get`")  # noqa: E501
        # verify the required parameter 'version' is set
        if self.api_client.client_side_validation and ('version' not in params or
                                                       params['version'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `version` when calling `get_facets_yaml_by_stack_using_get`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/cc-ui/v1/modules/stack/{stackName}/{intent}/{flavor}/{version}/fields', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def upload_module_using_post(self, file, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.upload_module_using_post(file, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.upload_module_using_post_with_http_info(file, **kwargs)  # noqa: E501
        else:
            (data) = self.upload_module_using_post_with_http_info(file, **kwargs)  # noqa: E501
            return data

    def upload_module_using_post_with_http_info(self, file, **kwargs):  # noqa: E501
        """Upload a module  # noqa: E501

        - **Description:** Uploads a module using a file. - **Permissions:** Requires MODULE_WRITE permission. - **Parameters:**   - `file`: The module file to upload   - `metadata` (optional): Additional module metadata including:     - `gitUrl`: Web URL of the git repository (Expected to embed the commit id)     - `gitRef`: Git reference (branch, tag, or commit)     - `isFeatureBranch`: If this is true, this preview module cannot be directly marked as published until we register the module again with this as false. - **Audit Logging:** Yes  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.upload_module_using_post_with_http_info(file, async_req=True)
        >>> result = thread.get()
