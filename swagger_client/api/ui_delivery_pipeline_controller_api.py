...
class UiDeliveryPipelineControllerApi(object):
    ...
    def update_delivery_pipeline_using_put(self, pipeline_nodes, stack_name, **kwargs):  # noqa: E501
        """updateDeliveryPipeline  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_delivery_pipeline_using_put(pipeline_nodes, stack_name, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param list[PipelineNode] pipeline_nodes: pipelineNodes (required)
        :param str stack_name: stackName (required)
        :return: list[PipelineNode]
                 If the method is called asynchronously,
                 returns the request thread.
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.update_delivery_pipeline_using_put_with_http_info(pipeline_nodes, stack_name, **kwargs)  # noqa: E501
        else:
            (data) = self.update_delivery_pipeline_using_put_with_http_info(pipeline_nodes, stack_name, **kwargs)  # noqa: E501
            return data

    def update_delivery_pipeline_using_put_with_http_info(self, pipeline_nodes, stack_name, **kwargs):  # noqa: E501
        """updateDeliveryPipeline  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_delivery_pipeline_using_put_with_http_info(pipeline_nodes, stack_name, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['pipeline_nodes', 'stack_name']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(params['kwargs']):
            ...
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'pipeline_nodes' is set
        if self.api_client.client_side_validation and ('pipeline_nodes' not in params or
                                                       params['pipeline_nodes'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `pipeline_nodes` when calling `update_delivery_pipeline_using_put`")  # noqa: E501
        # verify the required parameter 'stack_name' is set
        if self.api_client.client_side_validation and ('stack_name' not in params or
                                                       params['stack_name'] is None):  # noqa: E501
        ...
        body_params = None
        if 'pipeline_nodes' in params:
            body_params = params['pipeline_nodes']
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.select_header_accept(
            ['*/*'])  # noqa: E501
