...
class UiOpaControllerApi(object):
    ...
    def bulk_edit_opa_policy_state(self, body, **kwargs):  # noqa: E501
        ...
        :param list[ComCapillaryOpsCpBoOpaEnableDisableOPAPolicy] body: (required)
        :return: None
    ...
    def create_policy(self, body, policy_name, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param ComCapillaryOpsCpBoOpaOpaPolicyRequest body: (required)
        :param str policy_name: (required)
        :return: ComCapillaryOpsCpBoOpaOpaPolicy
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
    ...
    def create_policy_with_http_info(self, body, policy_name, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='ComCapillaryOpsCpBoOpaOpaPolicy',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def execute_policy(self, body, policy_name, **kwargs):  # noqa: E501
        ...
        :param str policy_name: (required)
        :return: ComCapillaryOpsCpBoOpaOpaPolicyExecutionResult
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
    ...
    def execute_policy_with_http_info(self, body, policy_name, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='ComCapillaryOpsCpBoOpaOpaPolicyExecutionResult',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def get_all_policies(self, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :return: list[ComCapillaryOpsCpBoOpaOpaPolicy]
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
    ...
    def get_all_policies_with_http_info(self, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='list[ComCapillaryOpsCpBoOpaOpaPolicy]',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def get_all_policy_templates(self, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :return: list[ComCapillaryOpsCpBoOpaPolicyTemplateDTO]
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
    ...
    def get_all_policy_templates_with_http_info(self, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='list[ComCapillaryOpsCpBoOpaPolicyTemplateDTO]',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
