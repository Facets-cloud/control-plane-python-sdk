...
class UiTfVersionControllerApi(object):
    ...
    def get_tf_versions_for_stream_using_get_with_http_info(self, tf_stream, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('tf_stream' not in params or
                                                       params['tf_stream'] is None):  # noqa: E501
    ...
    def set_tf_version_for_cluster_using_put(self, cluster_id, tf_version, **kwargs):  # noqa: E501
        """setTfVersionForCluster  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.set_tf_version_for_cluster_using_put(cluster_id, tf_version, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str cluster_id: clusterId (required)
        :param TfVersion tf_version: tfVersion (required)
        :return: ClusterTfVersionMapping
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.set_tf_version_for_cluster_using_put_with_http_info(cluster_id, tf_version, **kwargs)  # noqa: E501
        else:
            (data) = self.set_tf_version_for_cluster_using_put_with_http_info(cluster_id, tf_version, **kwargs)  # noqa: E501
            return data

    def set_tf_version_for_cluster_using_put_with_http_info(self, cluster_id, tf_version, **kwargs):  # noqa: E501
        """setTfVersionForCluster  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.set_tf_version_for_cluster_using_put_with_http_info(cluster_id, tf_version, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['cluster_id', 'tf_version']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        # verify the required parameter 'tf_version' is set
        if self.api_client.client_side_validation and ('tf_version' not in params or
                                                       params['tf_version'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `tf_version` when calling `set_tf_version_for_cluster_using_put`")  # noqa: E501
