...
class UiArtifactoryControllerApi(object):
    ...
    def create_artifactory_mirror(self, body, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param ComCapillaryOpsCpBoArtifactoryMirror body: (required)
        :return: ComCapillaryOpsCpBoArtifactoryMirror
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
    ...
    def create_artifactory_mirror_with_http_info(self, body, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='ComCapillaryOpsCpBoArtifactoryMirror',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def create_basic_docker_artifactory(self, body, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param ComCapillaryOpsCpBoArtifactoryDtoBasicDockerDTO body: (required)
        :return: ComCapillaryOpsCpBoArtifactoryBasicDockerArtifactory
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
    ...
    def create_basic_docker_artifactory_with_http_info(self, body, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='ComCapillaryOpsCpBoArtifactoryBasicDockerArtifactory',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def create_ecr_artifactory1(self, body, **kwargs):  # noqa: E501
        """create_ecr_artifactory1  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_ecr_artifactory1(body, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param ComCapillaryOpsCpBoECRArtifactory body: (required)
        :return: ComCapillaryOpsCpBoECRArtifactory
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.create_ecr_artifactory1_with_http_info(body, **kwargs)  # noqa: E501
        else:
            (data) = self.create_ecr_artifactory1_with_http_info(body, **kwargs)  # noqa: E501
            return data

    def create_ecr_artifactory1_with_http_info(self, body, **kwargs):  # noqa: E501
        """create_ecr_artifactory1  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_ecr_artifactory1_with_http_info(body, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method create_ecr_artifactory1" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'body' is set
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `create_ecr_artifactory1`")  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='ComCapillaryOpsCpBoECRArtifactory',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def get_all_artifactories1(self, **kwargs):  # noqa: E501
        """get_all_artifactories1  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_all_artifactories1(async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :return: list[ComCapillaryOpsCpBoArtifactory]
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_all_artifactories1_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.get_all_artifactories1_with_http_info(**kwargs)  # noqa: E501
            return data

    def get_all_artifactories1_with_http_info(self, **kwargs):  # noqa: E501
        """get_all_artifactories1  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_all_artifactories1_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_all_artifactories1" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='list[ComCapillaryOpsCpBoArtifactory]',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def get_artifactory_by_id(self, artifactory_id, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param str artifactory_id: (required)
        :return: ComCapillaryOpsCpBoArtifactory
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
    ...
    def get_artifactory_by_id_with_http_info(self, artifactory_id, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='ComCapillaryOpsCpBoArtifactory',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def request_artifactory_linking(self, body, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param ComCapillaryOpsCpBoArtifactoryDtoArtifactoryLinkingRequest body: (required)
    ...
    def update_ecr_artifactory1(self, body, artifactory_id, **kwargs):  # noqa: E501
        """update_ecr_artifactory1  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_ecr_artifactory1(body, artifactory_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.update_ecr_artifactory1_with_http_info(body, artifactory_id, **kwargs)  # noqa: E501
        else:
            (data) = self.update_ecr_artifactory1_with_http_info(body, artifactory_id, **kwargs)  # noqa: E501
            return data

    def update_ecr_artifactory1_with_http_info(self, body, artifactory_id, **kwargs):  # noqa: E501
        """update_ecr_artifactory1  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_ecr_artifactory1_with_http_info(body, artifactory_id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method update_ecr_artifactory1" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'body' is set
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `update_ecr_artifactory1`")  # noqa: E501
        # verify the required parameter 'artifactory_id' is set
        if ('artifactory_id' not in params or
                params['artifactory_id'] is None):
            raise ValueError("Missing the required parameter `artifactory_id` when calling `update_ecr_artifactory1`")  # noqa: E501
