...
class UiReleaseStreamControllerApi(object):
    ...
    def add_using_post(self, release_stream_request, **kwargs):  # noqa: E501
        """add  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.add_using_post(release_stream_request, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param ReleaseStreamRequest release_stream_request: releaseStreamRequest (required)
        ...
        if kwargs.get('async_req'):
            return self.add_using_post_with_http_info(release_stream_request, **kwargs)  # noqa: E501
        else:
            (data) = self.add_using_post_with_http_info(release_stream_request, **kwargs)  # noqa: E501
            return data

    def add_using_post_with_http_info(self, release_stream_request, **kwargs):  # noqa: E501
        """add  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.add_using_post_with_http_info(release_stream_request, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['release_stream_request']  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            ...
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'release_stream_request' is set
        if self.api_client.client_side_validation and ('release_stream_request' not in params or
                                                       params['release_stream_request'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `release_stream_request` when calling `add_using_post`")  # noqa: E501
        ...
        body_params = None
        if 'release_stream_request' in params:
            body_params = params['release_stream_request']
        # HTTP header `Accept`
