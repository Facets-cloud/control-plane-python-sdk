...
class UiResourceGroupControllerApi(object):
    ...
    def create(self, body, **kwargs):  # noqa: E501
        ...
        :param ComCapillaryOpsCpBoRequestsResourceGroupRequest body: (required)
        :return: ComCapillaryOpsCpBoResourceGroup
    ...
    def create_with_http_info(self, body, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            response_type='ComCapillaryOpsCpBoResourceGroup',  # noqa: E501
    ...
    def find_all(self, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :return: list[ComCapillaryOpsCpBoResourceGroup]
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
    ...
    def find_all_with_http_info(self, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='list[ComCapillaryOpsCpBoResourceGroup]',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def update_all_resources(self, body, resource_group_id, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param list[ComCapillaryOpsCpBoResourceGroupResourceInfo] body: (required)
        :param str resource_group_id: (required)
        :return: ComCapillaryOpsCpBoResourceGroup
                 If the method is called asynchronously,
                 returns the request thread.
    ...
    def update_resource(self, body, resource_group_id, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param ComCapillaryOpsCpBoResourceGroupResourceInfo body: (required)
        :param str resource_group_id: (required)
        :return: ComCapillaryOpsCpBoResourceGroup
                 If the method is called asynchronously,
                 returns the request thread.
