...
class UiProjectTypeControllerApi(object):
    ...
    def add_project_type_using_post(self, project_type_request, **kwargs):  # noqa: E501
        ...
        >>> thread = api.add_project_type_using_post(project_type_request, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param ProjectTypeRequest project_type_request: projectTypeRequest (required)
        ...
        if kwargs.get('async_req'):
            return self.add_project_type_using_post_with_http_info(project_type_request, **kwargs)  # noqa: E501
        else:
            (data) = self.add_project_type_using_post_with_http_info(project_type_request, **kwargs)  # noqa: E501
            return data

    def add_project_type_using_post_with_http_info(self, project_type_request, **kwargs):  # noqa: E501
        """Add a new project type  # noqa: E501

        - **Description:** Creates a new project type from the provided request details.  - **Restrictions:** Only users with the appropriate permissions can add project types.  - **Permissions:** Requires `PROJECT_TYPE_WRITE` permission.  - **Audit Logging:** This operation is logged for audit purposes.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.add_project_type_using_post_with_http_info(project_type_request, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['project_type_request']  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            ...
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'project_type_request' is set
        if self.api_client.client_side_validation and ('project_type_request' not in params or
                                                       params['project_type_request'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `project_type_request` when calling `add_project_type_using_post`")  # noqa: E501
        ...
        body_params = None
        if 'project_type_request' in params:
            body_params = params['project_type_request']
        # HTTP header `Accept`
    ...
    def update_project_type_using_put(self, id, project_type_request, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_project_type_using_put(id, project_type_request, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.update_project_type_using_put_with_http_info(id, project_type_request, **kwargs)  # noqa: E501
        else:
            (data) = self.update_project_type_using_put_with_http_info(id, project_type_request, **kwargs)  # noqa: E501
            return data

    def update_project_type_using_put_with_http_info(self, id, project_type_request, **kwargs):  # noqa: E501
        """Update an existing project type  # noqa: E501

        - **Description:** Updates details of a specified project type by its ID.  - **Restrictions:** Only users with the correct permissions can update project types.  - **Permissions:** Requires `PROJECT_TYPE_WRITE` permission.  - **Audit Logging:** This operation is logged for audit purposes.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_project_type_using_put_with_http_info(id, project_type_request, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['id', 'project_type_request']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if self.api_client.client_side_validation and ('project_type_request' not in params or
                                                       params['project_type_request'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `project_type_request` when calling `update_project_type_using_put`")  # noqa: E501
