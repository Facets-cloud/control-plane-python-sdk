...
class UiIacRepoControllerApi(object):
    ...
    def create_iac_repo_using_post(self, iac_repo, **kwargs):  # noqa: E501
        """createIacRepo  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_iac_repo_using_post(iac_repo, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param IacRepo iac_repo: iacRepo (required)
        :return: IacRepo
        ...
        if kwargs.get('async_req'):
            return self.create_iac_repo_using_post_with_http_info(iac_repo, **kwargs)  # noqa: E501
        else:
            (data) = self.create_iac_repo_using_post_with_http_info(iac_repo, **kwargs)  # noqa: E501
            return data

    def create_iac_repo_using_post_with_http_info(self, iac_repo, **kwargs):  # noqa: E501
        """createIacRepo  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_iac_repo_using_post_with_http_info(iac_repo, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            ...
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'iac_repo' is set
        if self.api_client.client_side_validation and ('iac_repo' not in params or
                                                       params['iac_repo'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `iac_repo` when calling `create_iac_repo_using_post`")  # noqa: E501
        ...
        body_params = None
        if 'iac_repo' in params:
            body_params = params['iac_repo']
        # HTTP header `Accept`
    ...
    def update_iac_repo_using_put(self, id, updated_iac_repo, **kwargs):  # noqa: E501
        """updateIacRepo  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_iac_repo_using_put(id, updated_iac_repo, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str id: id (required)
        :param IacRepo updated_iac_repo: updatedIacRepo (required)
        :return: IacRepo
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.update_iac_repo_using_put_with_http_info(id, updated_iac_repo, **kwargs)  # noqa: E501
        else:
            (data) = self.update_iac_repo_using_put_with_http_info(id, updated_iac_repo, **kwargs)  # noqa: E501
            return data

    def update_iac_repo_using_put_with_http_info(self, id, updated_iac_repo, **kwargs):  # noqa: E501
        """updateIacRepo  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_iac_repo_using_put_with_http_info(id, updated_iac_repo, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['id', 'updated_iac_repo']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        # verify the required parameter 'updated_iac_repo' is set
        if self.api_client.client_side_validation and ('updated_iac_repo' not in params or
                                                       params['updated_iac_repo'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `updated_iac_repo` when calling `update_iac_repo_using_put`")  # noqa: E501
        ...
        body_params = None
        if 'updated_iac_repo' in params:
            body_params = params['updated_iac_repo']
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.select_header_accept(
            ['*/*'])  # noqa: E501
