...
class UiDomainMappingControllerApi(object):
    ...
    def add_domain_mapping_using_post(self, cluster_id, domain, resource_name, resource_type, **kwargs):  # noqa: E501
        """addDomainMapping  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.add_domain_mapping_using_post(cluster_id, domain, resource_name, resource_type, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str cluster_id: clusterId (required)
        :param DomainDTO domain: domain (required)
        ...
        if kwargs.get('async_req'):
            return self.add_domain_mapping_using_post_with_http_info(cluster_id, domain, resource_name, resource_type, **kwargs)  # noqa: E501
        else:
            (data) = self.add_domain_mapping_using_post_with_http_info(cluster_id, domain, resource_name, resource_type, **kwargs)  # noqa: E501
            return data

    def add_domain_mapping_using_post_with_http_info(self, cluster_id, domain, resource_name, resource_type, **kwargs):  # noqa: E501
        """addDomainMapping  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.add_domain_mapping_using_post_with_http_info(cluster_id, domain, resource_name, resource_type, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['cluster_id', 'domain', 'resource_name', 'resource_type']  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('domain' not in params or
            ...
            raise ValueError("Missing the required parameter `domain` when calling `add_domain_mapping_using_post`")  # noqa: E501
    ...
    def update_domain_mapping_using_put(self, cluster_id, domain, resource_name, resource_type, **kwargs):  # noqa: E501
        """updateDomainMapping  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_domain_mapping_using_put(cluster_id, domain, resource_name, resource_type, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.update_domain_mapping_using_put_with_http_info(cluster_id, domain, resource_name, resource_type, **kwargs)  # noqa: E501
        else:
            (data) = self.update_domain_mapping_using_put_with_http_info(cluster_id, domain, resource_name, resource_type, **kwargs)  # noqa: E501
            return data

    def update_domain_mapping_using_put_with_http_info(self, cluster_id, domain, resource_name, resource_type, **kwargs):  # noqa: E501
        """updateDomainMapping  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_domain_mapping_using_put_with_http_info(cluster_id, domain, resource_name, resource_type, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('domain' not in params or
                                                       params['domain'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `domain` when calling `update_domain_mapping_using_put`")  # noqa: E501
        # verify the required parameter 'resource_name' is set
        if self.api_client.client_side_validation and ('resource_name' not in params or
                                                       params['resource_name'] is None):  # noqa: E501
