...
class UiKubernetesExplorerControllerApi(object):
    ...
    def container_logs_using_get_with_http_info(self, cluster_id, container_name, labels, pod_name, tail, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('tail' not in params or
                                                       params['tail'] is None):  # noqa: E501
    ...
    def get_config_map_data_using_get_with_http_info(self, cluster_id, config_map_name, labels, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('config_map_name' not in params or
                                                       params['config_map_name'] is None):  # noqa: E501
    ...
    def get_manifest_using_get_with_http_info(self, cluster_id, k8s_resource_name, k8s_resource_type, labels, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('k8s_resource_name' not in params or
                                                       params['k8s_resource_name'] is None):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('k8s_resource_type' not in params or
                                                       params['k8s_resource_type'] is None):  # noqa: E501
    ...
    def get_pods_for_deployment_using_get_with_http_info(self, cluster_id, deployment_name, labels, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('deployment_name' not in params or
                                                       params['deployment_name'] is None):  # noqa: E501
