...
class UiDeploymentControllerApi(object):
    ...
    def approve_release_using_post_with_http_info(self, cluster_id, deployment_id, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('deployment_id' not in params or
                                                       params['deployment_id'] is None):  # noqa: E501
    ...
    def create_deployment_using_post(self, cluster_id, deployment_request, **kwargs):  # noqa: E501
        """createDeployment  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_deployment_using_post(cluster_id, deployment_request, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str cluster_id: clusterId (required)
        :param DeploymentRequest deployment_request: deploymentRequest (required)
        :return: DeploymentLog
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.create_deployment_using_post_with_http_info(cluster_id, deployment_request, **kwargs)  # noqa: E501
        else:
            (data) = self.create_deployment_using_post_with_http_info(cluster_id, deployment_request, **kwargs)  # noqa: E501
            return data

    def create_deployment_using_post_with_http_info(self, cluster_id, deployment_request, **kwargs):  # noqa: E501
        """createDeployment  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_deployment_using_post_with_http_info(cluster_id, deployment_request, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['cluster_id', 'deployment_request']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        # verify the required parameter 'deployment_request' is set
        if self.api_client.client_side_validation and ('deployment_request' not in params or
                                                       params['deployment_request'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `deployment_request` when calling `create_deployment_using_post`")  # noqa: E501
        ...
        body_params = None
        if 'deployment_request' in params:
            body_params = params['deployment_request']
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.select_header_accept(
            ['*/*'])  # noqa: E501
    ...
    def release_v2_using_put_with_http_info(self, cluster_id, release_type, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('release_type' not in params or
                                                       params['release_type'] is None):  # noqa: E501
    ...
    def run_hotfix_deployment_recipe_using_post(self, cluster_id, deployment_recipe, **kwargs):  # noqa: E501
        """runHotfixDeploymentRecipe  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.run_hotfix_deployment_recipe_using_post(cluster_id, deployment_recipe, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str cluster_id: clusterId (required)
        :param HotfixDeploymentRecipe deployment_recipe: deploymentRecipe (required)
        :param bool allow_destroy: allowDestroy
        :param bool can_queue: canQueue
        :param str comment: comment
        :param bool force_release: forceRelease
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.run_hotfix_deployment_recipe_using_post_with_http_info(cluster_id, deployment_recipe, **kwargs)  # noqa: E501
        else:
            (data) = self.run_hotfix_deployment_recipe_using_post_with_http_info(cluster_id, deployment_recipe, **kwargs)  # noqa: E501
            return data

    def run_hotfix_deployment_recipe_using_post_with_http_info(self, cluster_id, deployment_recipe, **kwargs):  # noqa: E501
        """runHotfixDeploymentRecipe  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.run_hotfix_deployment_recipe_using_post_with_http_info(cluster_id, deployment_recipe, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['cluster_id', 'deployment_recipe', 'allow_destroy', 'can_queue', 'comment', 'force_release', 'is_plan', 'with_refresh']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        # verify the required parameter 'deployment_recipe' is set
        if self.api_client.client_side_validation and ('deployment_recipe' not in params or
                                                       params['deployment_recipe'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `deployment_recipe` when calling `run_hotfix_deployment_recipe_using_post`")  # noqa: E501
        ...
        body_params = None
        if 'deployment_recipe' in params:
            body_params = params['deployment_recipe']
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.select_header_accept(
            ['*/*'])  # noqa: E501
    ...
    def state_unlock_using_put_with_http_info(self, cluster_id, lock_id, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('lock_id' not in params or
                                                       params['lock_id'] is None):  # noqa: E501
