...
class UiBillingControllerApi(object):
    ...
    def buy_support_plan_using_post_with_http_info(self, cancel_url, success_url, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('cancel_url' not in params or
                                                       params['cancel_url'] is None):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('success_url' not in params or
                                                       params['success_url'] is None):  # noqa: E501
    ...
    def start_stripe_customer_portal_session_using_get_with_http_info(self, return_url, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('return_url' not in params or
                                                       params['return_url'] is None):  # noqa: E501
