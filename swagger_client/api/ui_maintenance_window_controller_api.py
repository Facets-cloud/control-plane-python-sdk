...
class UiMaintenanceWindowControllerApi(object):
    ...
    def enable_disable_using_put_with_http_info(self, cluster_id, disabled, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('disabled' not in params or
                                                       params['disabled'] is None):  # noqa: E501
    ...
    def update_using_put(self, maintenance_window_dto, **kwargs):  # noqa: E501
        """update  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_using_put(maintenance_window_dto, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param MaintenanceWindowDTO maintenance_window_dto: maintenanceWindowDTO (required)
        :return: MaintenanceWindowDTO
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.update_using_put_with_http_info(maintenance_window_dto, **kwargs)  # noqa: E501
        else:
            (data) = self.update_using_put_with_http_info(maintenance_window_dto, **kwargs)  # noqa: E501
            return data

    def update_using_put_with_http_info(self, maintenance_window_dto, **kwargs):  # noqa: E501
        """update  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_using_put_with_http_info(maintenance_window_dto, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['maintenance_window_dto']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if self.api_client.client_side_validation and ('maintenance_window_dto' not in params or
                                                       params['maintenance_window_dto'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `maintenance_window_dto` when calling `update_using_put`")  # noqa: E501
