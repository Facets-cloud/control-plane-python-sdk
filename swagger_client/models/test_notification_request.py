...
class TestNotificationRequest(object):
    ...
    def __init__(self, authorization_header=None, channel_address=None, channel_type=None, email_addresses=None, integration_key=None, notification_type=None, payload=None, _configuration=None):  # noqa: E501
