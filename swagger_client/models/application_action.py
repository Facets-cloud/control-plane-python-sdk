...
class ApplicationAction(object):
    ...
    def __init__(self, action_type=None, application_id=None, arguments=None, arguments_regex=None, build_type=None, id=None, metadata=None, name=None, path=None, _configuration=None):  # noqa: E501
