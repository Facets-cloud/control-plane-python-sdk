...
class ExpandedUser(object):
    ...
    def __init__(self, accessible_accounts=None, accessible_environments=None, accessible_projects=None, associated_resource_groups=None, base_role=None, env_specific_roles=None, groups=None, picture=None, user_id=None, user_roles=None, username=None, _configuration=None):  # noqa: E501
