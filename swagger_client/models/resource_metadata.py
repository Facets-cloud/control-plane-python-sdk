...
class ResourceMetadata(object):
    ...
    def __init__(self, artifact_url=None, commit_id=None, override_version=None, override_version_id=None, resource_name=None, resource_type=None, _configuration=None):  # noqa: E501
