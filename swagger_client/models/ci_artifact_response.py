...
class CiArtifactResponse(object):
    ...
    def __init__(self, applied_rule_id=None, applied_rule_name=None, applied_rule_version_id=None, artifact_id=None, artifact_name=None, artifact_uri=None, artifactory=None, build_description=None, classified=None, created_by=None, created_on=None, external_id=None, metadata=None, promoted=None, registration_type=None, registration_value=None, repository_name=None, tag=None, versioning_key=None, _configuration=None):  # noqa: E501
