...
class DeploymentRequest(object):
    ...
    def __init__(self, allow_destroy=None, alpha=None, approved_release=None, can_queue=None, extra_env=None, force_release=None, hotfix_resources=None, lock_id=None, override_build_steps=None, parallel_release=None, plan_code_build_id=None, queued_release_id=None, release_comment=None, release_trace_id=None, release_type=None, tf_version=None, with_refresh=None, _configuration=None):  # noqa: E501
    ...
    def override_build_steps(self, override_build_steps):
        ...
        :type: list[str]
        """
        if self._configuration.client_side_validation and override_build_steps is None:
