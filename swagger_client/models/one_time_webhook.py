...
class OneTimeWebhook(object):
    ...
    def __init__(self, created_by=None, creation_date=None, delete_at=None, error_message=None, expires_at=None, id=None, last_modified_by=None, last_modified_date=None, status=None, type=None, _configuration=None):  # noqa: E501
