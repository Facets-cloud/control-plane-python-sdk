...
class SecretsContextDTO(object):
    ...
    def __init__(self, cloud_account_secrets_id=None, cp_cloud=None, gcp_secret_manager_enabled=None, gcp_secret_manager_mode=None, gcp_secret_manager_project_id=None, provided_secrets_id=None, secret_manager_region=None, _configuration=None):  # noqa: E501
    ...
    def gcp_secret_manager_mode(self, gcp_secret_manager_mode):
        ...
        if (self._configuration.client_side_validation and
                gcp_secret_manager_mode not in allowed_values):
            raise ValueError(
