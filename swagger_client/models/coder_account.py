...
class CoderAccount(object):
    ...
    def __init__(self, account_type=None, api_token=None, associated_to=None, change_log=None, created_by=None, creation_date=None, default=None, entity_type=None, id=None, in_use=None, last_modified_by=None, last_modified_date=None, name=None, number_of_versions=None, organization_id=None, provider=None, secrets_uid=None, system_defined=None, template_id=None, url=None, versioning_key=None, _configuration=None):  # noqa: E501
