...
class SnapshotInfo(object):
    ...
    def __init__(self, cloud_specific_id=None, cluster_id=None, end_time=None, instance_name=None, name=None, pinned=None, resource_type=None, source=None, start_time=None, storage_size=None, _configuration=None):  # noqa: E501
