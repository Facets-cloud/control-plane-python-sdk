...
class DeploymentLog(object):
    ...
    def deployment_job_type(self, deployment_job_type):
        ...
        if (self._configuration.client_side_validation and
                deployment_job_type not in allowed_values):
            raise ValueError(
    ...
    def status_deprecated(self, status_deprecated):
        ...
        if (self._configuration.client_side_validation and
                status_deprecated not in allowed_values):
            raise ValueError(
