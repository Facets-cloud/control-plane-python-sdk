...
class AwsClusterRequest(object):
    ...
    def __init__(self, access_key_id=None, auto_sign_off_schedule=None, azs=None, base_cluster_id=None, cd_pipeline_parent=None, cloud=None, cloud_account_id=None, cluster_name=None, component_versions=None, enable_auto_sign_off=None, instance_types=None, is_ephemeral=None, k8s_requests_to_limits_ratio=None, namespace=None, provided_vpcid=None, region=None, release_stream=None, require_sign_off=None, schedules=None, secret_access_key=None, stack_name=None, tz=None, vpc_cidr=None, _configuration=None):  # noqa: E501
