...
class AvailabilityTaskSchedule(object):
    ...
    def __init__(self, by_day=None, by_time=None, cron_expr=None, description=None, frequency=None, interval=None, release_type=None, time_zone=None, _configuration=None):  # noqa: E501
