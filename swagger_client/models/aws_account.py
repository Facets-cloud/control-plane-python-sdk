...
class AwsAccount(object):
    ...
    def __init__(self, account_type=None, associated_to=None, change_log=None, created_by=None, creation_date=None, entity_type=None, external_id=None, iam_role=None, id=None, in_use=None, last_modified_by=None, last_modified_date=None, name=None, number_of_versions=None, provider=None, secrets_uid=None, system_defined=None, versioning_key=None, _configuration=None):  # noqa: E501
