...
class ListDeploymentsWrapper(object):
    ...
    def __init__(self, cluster_id=None, current_signed_off_deployment=None, deployments=None, deployments_full=None, deployments_stats=None, down_stream_cluster_names=None, next_execution_time=None, stack=None, time_to_next_execution=None, _configuration=None):  # noqa: E501
