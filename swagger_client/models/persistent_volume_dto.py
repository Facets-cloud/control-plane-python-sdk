...
class PersistentVolumeDTO(object):
    ...
    def __init__(self, age_in_seconds=None, capacity=None, claim=None, name=None, pv_access_modes=None, reason=None, reclaim_policy=None, status=None, storage_class=None, _configuration=None):  # noqa: E501
