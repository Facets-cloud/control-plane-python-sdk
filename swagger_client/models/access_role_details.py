...
class AccessRoleDetails(object):
    ...
    def __init__(self, cluster_id=None, environment=None, group_id=None, group_name=None, role_label=None, role_name=None, role_type=None, _configuration=None):  # noqa: E501
