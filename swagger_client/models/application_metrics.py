...
class ApplicationMetrics(object):
    ...
    def __init__(self, alerts=None, application_id=None, build_failures=None, critical_code_smells=None, _date=None, errors=None, fatal_errors_from_logs=None, issues_reported=None, outages=None, regression_coverage=None, regression_failures=None, response_time=None, sonar_url=None, unit_test_coverage=None, unit_tests=None, _configuration=None):  # noqa: E501
