...
class NotificationChannel(object):
    ...
    def __init__(self, authorization_header=None, channel_address=None, channel_type=None, email_addresses=None, id=None, integration_key=None, name=None, _configuration=None):  # noqa: E501
