...
class StackGitLog(object):
    ...
    def __init__(self, cluster_id=None, commit_log=None, directory=None, filename=None, id=None, number_of_versions=None, resource_name=None, resource_type=None, stack_name=None, versioning_key=None, _configuration=None):  # noqa: E501
