...
class IntentRequestDTO(object):
    ...
    def __init__(self, description=None, display_name=None, icon_url=None, inferred_from_module=None, intent_outputs=None, name=None, type=None, _configuration=None):  # noqa: E501
