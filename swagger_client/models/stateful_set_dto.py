...
class StatefulSetDTO(object):
    ...
    def __init__(self, age_in_seconds=None, desired_replicas=None, name=None, pod_count=None, ready_replicas=None, replicas=None, status=None, _configuration=None):  # noqa: E501
