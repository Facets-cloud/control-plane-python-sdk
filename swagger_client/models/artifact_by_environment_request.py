...
class ArtifactByEnvironmentRequest(object):
    ...
    def __init__(self, application_name=None, artifact_uri=None, artifactory=None, cluster_name=None, description=None, external_id=None, stack_name=None, _configuration=None):  # noqa: E501
