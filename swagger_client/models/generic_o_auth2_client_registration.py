...
class GenericOAuth2ClientRegistration(object):
    ...
    def __init__(self, authorization_uri=None, client_authentication_method=None, client_id=None, client_secret=None, issuer_url=None, jwk_set_uri=None, login_button_text=None, provider=None, registration_id=None, scope=None, secrets_uid=None, system_configured=None, token_uri=None, user_info_uri=None, _configuration=None):  # noqa: E501
