...
class Subscription(object):
    ...
    def __init__(self, channel_address=None, channel_id=None, channel_type=None, filters=None, id=None, name=None, notification_subject=None, notification_type=None, payload_json=None, stack_name=None, test=None, _configuration=None):  # noqa: E501
