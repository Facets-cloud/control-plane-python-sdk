...
class ApplicationDeploymentDetails(object):
    ...
    def __init__(self, creation_timestamp=None, credentials_list=None, environment_configs=None, hpa_status=None, labels=None, name=None, replicas=None, _configuration=None):  # noqa: E501
