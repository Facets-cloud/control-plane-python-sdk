...
class Chat(object):
    ...
    def __init__(self, cluster_id=None, context=None, created_by=None, creation_date=None, id=None, last_modified_by=None, last_modified_date=None, metadata=None, title=None, total_tokens=None, _configuration=None):  # noqa: E501
