...
class AzureClusterRequest(object):
    ...
    def __init__(self, auto_sign_off_schedule=None, azs=None, base_cluster_id=None, cd_pipeline_parent=None, client_id=None, client_secret=None, cloud=None, cloud_account_id=None, cluster_name=None, component_versions=None, enable_auto_sign_off=None, instance_types=None, is_ephemeral=None, k8s_requests_to_limits_ratio=None, namespace=None, region=None, release_stream=None, require_sign_off=None, resource_group_name=None, schedules=None, stack_name=None, subscription_id=None, tenant_id=None, tz=None, vnet_name=None, vpc_cidr=None, _configuration=None):  # noqa: E501
