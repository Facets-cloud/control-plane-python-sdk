...
class FacetsAuditLogResponse(object):
    ...
    def __init__(self, cluster_id=None, cluster_name=None, entity=None, entity_action=None, entity_action_label=None, entity_label=None, id=None, metadata=None, performed_at=None, performed_by=None, stack_name=None, target=None, _configuration=None):  # noqa: E501
    ...
    def entity_action(self, entity_action):
        ...
        if (self._configuration.client_side_validation and
                entity_action not in allowed_values):
            raise ValueError(
