...
class CopyConfigurationsRequest(object):
    ...
    def __init__(self, configuration_types=None, selection_mode=None, source_cluster_id=None, _configuration=None):  # noqa: E501
    ...
    def selection_mode(self, selection_mode):
        ...
        if (self._configuration.client_side_validation and
                selection_mode not in allowed_values):
            raise ValueError(
