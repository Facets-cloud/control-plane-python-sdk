...
class ClusterSchedule(object):
    ...
    def __init__(self, by_day=None, by_time=None, cluster_id=None, created_by=None, creation_date=None, description=None, frequency=None, id=None, interval=None, is_paused=None, last_modified_by=None, last_modified_date=None, release_type=None, server_time_zone=None, time_zone=None, _configuration=None):  # noqa: E501
    ...
    def by_day(self, by_day):
        ...
        if (self._configuration.client_side_validation and
                not set(by_day).issubset(set(allowed_values))):  # noqa: E501
            raise ValueError(
