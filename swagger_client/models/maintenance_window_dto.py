...
class MaintenanceWindowDTO(object):
    ...
    def __init__(self, cluster_id=None, created_by=None, creation_date=None, cron=None, day_of_week=None, disabled=None, end_time=None, id=None, last_modified_by=None, last_modified_date=None, start_time=None, time_zone=None, triggered=None, _configuration=None):  # noqa: E501
