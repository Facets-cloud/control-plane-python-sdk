...
class BasicDockerDTO(object):
    ...
    def __init__(self, artifactory_name=None, artifactory_type=None, password=None, stacks_associated=None, uri=None, username=None, _configuration=None):  # noqa: E501
