...
class CiCdDto(object):
    ...
    def __init__(self, ci_system=None, map_to_all_cis=None, promotion_hierarchies=None, registration_type=None, routing_rules=None, stack_name=None, _configuration=None):  # noqa: E501
    ...
    def ci_system(self, ci_system):
        ...
        if (self._configuration.client_side_validation and
                ci_system not in allowed_values):
            raise ValueError(
    ...
    def promotion_hierarchies(self, promotion_hierarchies):
        ...
        """
        if self._configuration.client_side_validation and promotion_hierarchies is None:
    ...
    def routing_rules(self, routing_rules):
        ...
        :type: list[Criterion]
        """
        if self._configuration.client_side_validation and routing_rules is None:
