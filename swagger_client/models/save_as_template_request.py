...
class SaveAsTemplateRequest(object):
    ...
    def __init__(self, account_id=None, clouds=None, description=None, git_ref=None, git_url=None, group=None, name=None, organisation_name=None, relative_path=None, type=None, _configuration=None):  # noqa: E501
    ...
    def clouds(self, clouds):
        ...
        if (self._configuration.client_side_validation and
                not set(clouds).issubset(set(allowed_values))):  # noqa: E501
            raise ValueError(
