...
class ResourceChange(object):
    ...
    def __init__(self, change_type=None, changed_attributes=None, resource_name=None, resource_type=None, _configuration=None):  # noqa: E501
    ...
    def change_type(self, change_type):
        ...
        if (self._configuration.client_side_validation and
                change_type not in allowed_values):
            raise ValueError(
