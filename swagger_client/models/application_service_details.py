...
class ApplicationServiceDetails(object):
    ...
    def __init__(self, creation_timestamp=None, external_dns=None, external_endpoints=None, internal_endpoints=None, labels=None, name=None, selectors=None, service_type=None, _configuration=None):  # noqa: E501
