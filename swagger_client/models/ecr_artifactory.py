...
class ECRArtifactory(object):
    ...
    def __init__(self, artifactory_type=None, aws_account_id=None, aws_key=None, aws_region=None, aws_secret=None, change_log=None, created_by=None, creation_date=None, entity_type=None, id=None, last_modified_by=None, last_modified_date=None, name=None, number_of_versions=None, stacks_associated=None, system_defined=None, uri=None, versioning_key=None, _configuration=None):  # noqa: E501
