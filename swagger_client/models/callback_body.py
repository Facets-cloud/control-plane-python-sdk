...
class CallbackBody(object):
    ...
    def __init__(self, app_id=None, application_family=None, branch=None, deployer_build_id=None, pr_number=None, properties=None, quality_gate=None, status=None, _configuration=None):  # noqa: E501
