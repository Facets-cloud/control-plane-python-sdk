...
class Deployment(object):
    ...
    def __init__(self, application_family=None, application_id=None, build_id=None, configurations=None, configurations_map=None, deployed_by=None, environment=None, horizontal_pod_autoscaler=None, id=None, pod_size=None, replicas=None, rollback_enabled=None, schedule=None, timestamp=None, _configuration=None):  # noqa: E501
    ...
    def pod_size(self, pod_size):
        ...
        if (self._configuration.client_side_validation and
                pod_size not in allowed_values):
            raise ValueError(
