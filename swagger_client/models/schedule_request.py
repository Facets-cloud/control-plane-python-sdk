...
class ScheduleRequest(object):
    ...
    def __init__(self, by_day=None, by_time=None, frequency=None, interval=None, pause_release_schedule=None, release_type=None, time_zone=None, _configuration=None):  # noqa: E501
