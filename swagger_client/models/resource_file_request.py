...
class ResourceFileRequest(object):
    ...
    def __init__(self, content=None, directory=None, filename=None, flavor=None, merge_content=None, resource_name=None, resource_type=None, _configuration=None):  # noqa: E501
