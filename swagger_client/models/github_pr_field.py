...
class GithubPRField(object):
    ...
    def __init__(self, base=None, comments_url=None, diff_url=None, draft=None, head=None, merged=None, state=None, updated_at=None, url=None, _configuration=None):  # noqa: E501
