...
class CreateProjectRequest(object):
    ...
    def __init__(self, allowed_clouds=None, bitbucket_project_key=None, blueprint_name=None, cloud=None, description=None, draft_clusters=None, git_ops_request=None, org_name=None, project_type_id=None, template_id=None, vcs_account_id=None, _configuration=None):  # noqa: E501
