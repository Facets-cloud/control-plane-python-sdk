...
class ResourceHistory(object):
    ...
    def __init__(self, alpha=None, artifact_version=None, blueprint_version=None, cluster_id=None, cluster_name=None, disabled=None, override_version=None, resource_name=None, resource_status=None, resource_type=None, _configuration=None):  # noqa: E501
