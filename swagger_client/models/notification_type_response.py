...
class NotificationTypeResponse(object):
    ...
    def __init__(self, key=None, notification_name=None, notification_type=None, supported_tags=None, _configuration=None):  # noqa: E501
    ...
    def supported_tags(self, supported_tags):
        ...
        if (self._configuration.client_side_validation and
                not set(supported_tags).issubset(set(allowed_values))):  # noqa: E501
            raise ValueError(
