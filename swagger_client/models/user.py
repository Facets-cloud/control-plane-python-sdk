...
class User(object):
    ...
    def __init__(self, cluster_ids=None, group_id=None, group_ids=None, id=None, picture=None, roles=None, teams=None, user_name=None, _configuration=None):  # noqa: E501
