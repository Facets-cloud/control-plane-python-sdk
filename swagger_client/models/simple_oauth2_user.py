...
class SimpleOauth2User(object):
    ...
    def __init__(self, allowed_accounts=None, allowed_cluster_ids=None, allowed_stack_names=None, associated_to_resource_group=None, attributes=None, authorities=None, cluster_role_binding=None, name=None, stack_resources=None, user_id=None, _configuration=None):  # noqa: E501
