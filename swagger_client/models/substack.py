...
class Substack(object):
    ...
    def primary_cloud(self, primary_cloud):
        ...
        allowed_values = ["AWS", "AZURE", "LOCAL", "GCP", "KUBERNETES"]  # noqa: E501
        if (self._configuration.client_side_validation and
                primary_cloud not in allowed_values):
            raise ValueError(
