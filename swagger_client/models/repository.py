...
class Repository(object):
    ...
    def __init__(self, display_name=None, kind=None, name=None, official=None, organization_display_name=None, organization_name=None, repository_id=None, scanner_disabled=None, url=None, verified_publisher=None, _configuration=None):  # noqa: E501
