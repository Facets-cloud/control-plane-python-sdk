...
class ProvidedResources(object):
    ...
    def __init__(self, cluster_id=None, id=None, provided_authenticated_resources=None, provided_cloud_resources=None, provided_sharded_resources=None, provided_unauthenticated_resources=None, _configuration=None):  # noqa: E501
