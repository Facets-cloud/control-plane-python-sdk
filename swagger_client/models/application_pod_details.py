...
class ApplicationPodDetails(object):
    ...
    def __init__(self, creation_timestamp=None, image=None, image_id=None, labels=None, name=None, pod_status=None, ready=None, resource_usage=None, restart_reason=None, restarts=None, _configuration=None):  # noqa: E501
