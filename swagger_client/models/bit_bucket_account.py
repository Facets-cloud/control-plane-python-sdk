...
class BitBucketAccount(object):
    ...
    def __init__(self, access_token=None, account_type=None, app=None, associated_to=None, change_log=None, created_by=None, creation_date=None, entity_type=None, host=None, id=None, in_use=None, last_modified_by=None, last_modified_date=None, name=None, number_of_versions=None, org_name=None, project_key=None, provider=None, secrets_uid=None, system_defined=None, user_name=None, versioning_key=None, _configuration=None):  # noqa: E501
