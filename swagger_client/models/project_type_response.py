...
class ProjectTypeResponse(object):
    ...
    def __init__(self, allowed_clouds=None, associated_blueprints=None, base_project_name=None, created_by=None, creation_date=None, description=None, id=None, last_modified_by=None, last_modified_date=None, mapped_resources=None, name=None, template_git_details=None, _configuration=None):  # noqa: E501
