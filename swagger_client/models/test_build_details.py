...
class TestBuildDetails(object):
    ...
    def __init__(self, application_family=None, application_id=None, branch=None, branch_type=None, build_id=None, id=None, pr_id=None, sonar_url=None, test_status=None, test_status_rules=None, timestamp=None, _configuration=None):  # noqa: E501
    ...
    def test_status(self, test_status):
        ...
        if (self._configuration.client_side_validation and
                test_status not in allowed_values):
            raise ValueError(
