...
class ResourceHistoryOverview(object):
    ...
    def __init__(self, artifact_version=None, blueprint_version=None, cluster_id=None, cluster_name=None, disabled=None, overridden=None, override_version=None, release_button_status=None, resource_name=None, resource_status=None, resource_type=None, _configuration=None):  # noqa: E501
