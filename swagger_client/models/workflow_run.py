...
class WorkflowRun(object):
    ...
    def __init__(self, actor=None, conclusion=None, created_at=None, display_title=None, head_branch=None, head_commit=None, html_url=None, name=None, run_number=None, run_started_at=None, status=None, triggering_actor=None, updated_at=None, workflow_id=None, _configuration=None):  # noqa: E501
