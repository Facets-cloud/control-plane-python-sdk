...
class Package(object):
    ...
    def __init__(self, all_containers_images_whitelisted=None, app_version=None, category=None, deprecated=None, description=None, has_values_schema=None, logo_image_id=None, name=None, normalized_name=None, official=None, package_id=None, production_organizations_count=None, repository=None, security_report_summary=None, signed=None, stars=None, ts=None, version=None, _configuration=None):  # noqa: E501
