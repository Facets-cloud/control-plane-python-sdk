...
class UserGroup(object):
    ...
    def __init__(self, accounts=None, additional_roles=None, associated_resource_groups=None, base_role=None, change_log=None, cluster_ids=None, cluster_role_bindings=None, entity_type=None, group_name=None, id=None, number_of_versions=None, stack_names=None, versioning_key=None, _configuration=None):  # noqa: E501
