...
class ActionExecution(object):
    ...
    def __init__(self, action=None, application_id=None, id=None, output=None, trigger_exception=None, trigger_status=None, trigger_time=None, _configuration=None):  # noqa: E501
    ...
    def trigger_status(self, trigger_status):
        ...
        if (self._configuration.client_side_validation and
                trigger_status not in allowed_values):
            raise ValueError(
