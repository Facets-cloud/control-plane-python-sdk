...
class DailyCloudCostDTO(object):
    ...
    def __init__(self, daily_cost=None, last_sync=None, previous_period_total=None, service_cost=None, stack_name=None, total=None, unit=None, _configuration=None):  # noqa: E501
