...
class Input(object):
    ...
    def __init__(self, adds_capability=None, block_edits=None, default_resource=None, description=None, display_name=None, optional=None, type=None, _configuration=None):  # noqa: E501
