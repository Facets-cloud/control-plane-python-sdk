...
class RoleMapping(object):
    ...
    def __init__(self, base_role=None, description=None, entities=None, k8s_cluster_role=None, k8s_role=None, label=None, last_modified_by=None, last_modified_date=None, role_name=None, role_type=None, _configuration=None):  # noqa: E501
