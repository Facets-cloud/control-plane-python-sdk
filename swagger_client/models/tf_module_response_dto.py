...
class TFModuleResponseDTO(object):
    ...
    def __init__(self, alias_flavors=None, allowed_test_projects=None, clouds=None, created_by=None, creation_date=None, description=None, feature_branch=None, flavor=None, git_ref=None, git_url=None, id=None, inputs=None, intent=None, intent_details=None, last_modified_by=None, last_modified_date=None, latest_version=None, metadata=None, other_versions=None, outputs=None, preview_module_id=None, published_module_id=None, readme_md=None, sample_json=None, source=None, spec=None, stage=None, tags=None, type=None, version=None, versioning_key=None, _configuration=None):  # noqa: E501
