...
class ArtifactCI(object):
    ...
    def __init__(self, ci_name=None, created_by=None, creation_date=None, entity_type=None, id=None, integration_type=None, last_modified_by=None, last_modified_date=None, promotion_workflow_id=None, registration_type=None, rule_id=None, stack_name=None, _configuration=None):  # noqa: E501
    ...
    def integration_type(self, integration_type):
        ...
        if (self._configuration.client_side_validation and
                integration_type not in allowed_values):
            raise ValueError(
