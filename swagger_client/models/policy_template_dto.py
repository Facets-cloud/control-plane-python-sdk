...
class PolicyTemplateDTO(object):
    ...
    def __init__(self, description=None, flavours=None, input_data=None, resource_types=None, template_id=None, template_name=None, _configuration=None):  # noqa: E501
