...
class AttachDetachCiRequest(object):
    ...
    def __init__(self, blueprint_name=None, ci_name=None, registration_type=None, _configuration=None):  # noqa: E501
    ...
    def ci_name(self, ci_name):
        ...
        :type: str
        """
        if self._configuration.client_side_validation and ci_name is None:
