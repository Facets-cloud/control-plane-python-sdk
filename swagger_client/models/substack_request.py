...
class SubstackRequest(object):
    ...
    def __init__(self, branch=None, name=None, relative_path=None, tf_module=None, vcs=None, vcs_url=None, version_control_account_id=None, _configuration=None):  # noqa: E501
