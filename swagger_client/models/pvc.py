...
class PVC(object):
    ...
    def __init__(self, access_mode=None, mount_path=None, name=None, storage_size=None, volume_directory=None, _configuration=None):  # noqa: E501
    ...
    def access_mode(self, access_mode):
        ...
        if (self._configuration.client_side_validation and
                access_mode not in allowed_values):
            raise ValueError(
