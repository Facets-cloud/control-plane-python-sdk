...
class PromotionWorkflow(object):
    ...
    def __init__(self, created_by=None, creation_date=None, default_workflow=None, hierarchies=None, id=None, last_modified_by=None, last_modified_date=None, registration_type=None, stack_name=None, workflow_name=None, _configuration=None):  # noqa: E501
