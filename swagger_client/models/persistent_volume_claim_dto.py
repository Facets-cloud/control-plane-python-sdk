...
class PersistentVolumeClaimDTO(object):
    ...
    def __init__(self, age_in_seconds=None, associated_pods=None, capacity=None, name=None, pvc_access_modes=None, status=None, storage_class=None, volume=None, _configuration=None):  # noqa: E501
