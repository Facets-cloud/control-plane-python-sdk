...
class ImageOverrideRequest(object):
    ...
    def __init__(self, artifact_type=None, artifact_uri=None, artifactory=None, blueprint_name=None, ci_name=None, registration_type=None, registration_value=None, repository_name=None, resource_name=None, resource_type=None, tag=None, _configuration=None):  # noqa: E501
