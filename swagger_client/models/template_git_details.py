...
class TemplateGitDetails(object):
    ...
    def __init__(self, account_id=None, git_ref=None, git_url=None, path=None, _configuration=None):  # noqa: E501
    ...
    def git_ref(self, git_ref):
        ...
        :type: str
        """
        if self._configuration.client_side_validation and git_ref is None:
