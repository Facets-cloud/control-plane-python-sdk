...
class TFModuleListResponseDTO(object):
    ...
    def __init__(self, clouds=None, created_by=None, creation_date=None, feature_branch=None, flavor=None, git_ref=None, git_url=None, id=None, intent_details=None, last_modified_by=None, last_modified_date=None, preview_git_ref=None, preview_git_url=None, preview_module_id=None, source=None, stage=None, tags=None, type=None, version=None, _configuration=None):  # noqa: E501
