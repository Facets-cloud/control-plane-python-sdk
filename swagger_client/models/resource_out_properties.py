...
class ResourceOutProperties(object):
    ...
    def __init__(self, attributes=None, cluster_id=None, id=None, interfaces=None, resource_name=None, resource_type=None, updated_at=None, _configuration=None):  # noqa: E501
