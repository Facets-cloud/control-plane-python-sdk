...
class TFModule(object):
    ...
    def __init__(self, account_id=None, alias_flavors=None, allowed_test_projects=None, clouds=None, contains_overridable_fields=None, created_by=None, creation_date=None, description=None, facets_yaml=None, feature_branch=None, flavor=None, git_ref=None, git_url=None, id=None, inputs=None, intent=None, last_modified_by=None, last_modified_date=None, metadata=None, number_of_versions=None, outputs=None, path=None, readme_md=None, relative_path=None, sample_json=None, source=None, spec=None, spec_modeled=None, stage=None, tags=None, type=None, version=None, versioning_key=None, _configuration=None):  # noqa: E501
    ...
    def path(self):
        ...
        Path information related to TF Module  # noqa: E501
