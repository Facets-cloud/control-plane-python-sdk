...
class K8sCredentials(object):
    ...
    def __init__(self, id=None, kubernetes_api_endpoint=None, kubernetes_token=None, proxy_http_client_factory=None, proxy_url=None, _configuration=None):  # noqa: E501
