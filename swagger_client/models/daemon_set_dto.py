...
class DaemonSetDTO(object):
    ...
    def __init__(self, age_in_seconds=None, available=None, current=None, desired=None, name=None, node_selector=None, ready=None, up_to_date=None, _configuration=None):  # noqa: E501
