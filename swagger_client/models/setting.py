...
class Setting(object):
    ...
    def __init__(self, allowed_values=None, created_by=None, creation_date=None, default_value=None, description=None, entity=None, id=None, last_modified_by=None, last_modified_date=None, max=None, min=None, name=None, setting_type=None, supported_for_clouds=None, _configuration=None):  # noqa: E501
    ...
    def setting_type(self, setting_type):
        ...
        if (self._configuration.client_side_validation and
                setting_type not in allowed_values):
            raise ValueError(
    ...
    def supported_for_clouds(self, supported_for_clouds):
        ...
        if (self._configuration.client_side_validation and
                not set(supported_for_clouds).issubset(set(allowed_values))):  # noqa: E501
            raise ValueError(
