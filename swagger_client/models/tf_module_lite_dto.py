...
class TFModuleLiteDTO(object):
    ...
    def __init__(self, allowed_test_projects=None, clouds=None, flavor=None, id=None, inputs=None, intent=None, intent_type=None, source=None, stage=None, tags=None, version=None, _configuration=None):  # noqa: E501
