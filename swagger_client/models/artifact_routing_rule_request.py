...
class ArtifactRoutingRuleRequest(object):
    ...
    def __init__(self, ci_system=None, criteria=None, id=None, is_default=None, registration_type=None, rule_name=None, stack_name=None, _configuration=None):  # noqa: E501
