...
class ResourceGroup(object):
    ...
    def __init__(self, created_by=None, creation_date=None, id=None, last_modified_by=None, last_modified_date=None, name=None, resource_info=None, _configuration=None):  # noqa: E501
