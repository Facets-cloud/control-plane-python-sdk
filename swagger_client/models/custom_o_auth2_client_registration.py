...
class CustomOAuth2ClientRegistration(object):
    ...
    def __init__(self, client_id=None, client_secret=None, is_system_configured=None, issuer_url=None, login_button_text=None, provider=None, registration_id=None, scope=None, secrets_uid=None, system_configured=None, _configuration=None):  # noqa: E501
