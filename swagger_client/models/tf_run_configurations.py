...
class TFRunConfigurations(object):
    ...
    def __init__(self, additional_env_vars=None, branch_override=None, cluster_id=None, created_by=None, creation_date=None, id=None, last_modified_by=None, last_modified_date=None, _configuration=None):  # noqa: E501
