...
class CustomerOnboardRequest(object):
    ...
    def __init__(self, azs=None, customer_name=None, external_id=None, region=None, release_stream=None, role_arn=None, timezone=None, _configuration=None):  # noqa: E501
