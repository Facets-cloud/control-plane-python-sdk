...
class HPADetails(object):
    ...
    def __init__(self, current_cpu_avg=None, current_replicas=None, desired_replicas=None, max_replicas=None, min_replicas=None, target_cpu_avg=None, _configuration=None):  # noqa: E501
