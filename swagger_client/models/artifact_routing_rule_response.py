...
class ArtifactRoutingRuleResponse(object):
    ...
    def __init__(self, created_by=None, creation_date=None, criteria=None, default=None, id=None, registration_type=None, rule_name=None, stack_name=None, _configuration=None):  # noqa: E501
