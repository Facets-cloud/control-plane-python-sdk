...
class QueuedRelease(object):
    ...
    def __init__(self, allow_destroy=None, can_queue=None, cluster_id=None, comment=None, creation_date=None, force_release=None, hotfix_resources=None, id=None, override_build_steps=None, parallel_release=None, release_trace_id=None, release_type=None, tf_version=None, triggered_by=None, with_refresh=None, _configuration=None):  # noqa: E501
