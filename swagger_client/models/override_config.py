...
class OverrideConfig(object):
    ...
    def __init__(self, branch_name=None, git_org_name=None, git_override_url=None, migration_failure_message=None, overrides_migration_status=None, overrides_repo_name=None, ui_overrides_enabled=None, _configuration=None):  # noqa: E501
    ...
    def overrides_migration_status(self, overrides_migration_status):
        ...
        if (self._configuration.client_side_validation and
                overrides_migration_status not in allowed_values):
            raise ValueError(
