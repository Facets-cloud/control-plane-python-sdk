...
class OverrideObject(object):
    ...
    def __init__(self, change_log=None, commit_id=None, created_by=None, creation_date=None, id=None, last_modified_by=None, last_modified_date=None, number_of_versions=None, overrides=None, resource_name=None, resource_type=None, versioning_key=None, _configuration=None):  # noqa: E501
