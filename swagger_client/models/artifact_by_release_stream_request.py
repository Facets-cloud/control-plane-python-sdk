...
class ArtifactByReleaseStreamRequest(object):
    ...
    def __init__(self, application_name=None, artifact_uri=None, artifactory=None, description=None, external_id=None, release_stream=None, stack_name=None, _configuration=None):  # noqa: E501
