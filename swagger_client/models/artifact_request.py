...
class ArtifactRequest(object):
    ...
    def __init__(self, application_name=None, artifact_uri=None, artifactory=None, cluster_id=None, description=None, external_id=None, metadata=None, promoted=None, registered_for=None, registration_type=None, release_stream=None, rule_id=None, rule_name=None, rule_version_id=None, stack_name=None, tag=None, _configuration=None):  # noqa: E501
    ...
    def registered_for(self, registered_for):
        ...
        if (self._configuration.client_side_validation and
                registered_for not in allowed_values):
            raise ValueError(
